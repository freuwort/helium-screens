export default {
    ...
    view_order: [
        1,2,3,5,6,7,8,15,16,17,18,19,20,21,24,4,5
    ],
    views: [
        ...
        { id: 4, on_days: [0, 1, 2, 3, 4, 5, 6], components: [{ background: '/images/poster/Wahl1.jpg' }] },
        { id: 5,on_days: [0, 1, 2, 3, 4, 5, 6], components: [{ background: '/images/poster/Wahl2.jpg' }] },
        ...
        {id: 15, on_days: [1, 4, 0, 5], components: [{ background: '/images/poster/jtl_1.jpg' }]},
        {id: 16, on_days: [2, 5], components: [{ background: '/images/poster/jtl_2.jpg' }]},
        {id: 17, on_days: [3, 6, 5], components: [{ background: '/images/poster/jtl_3.jpg' }]},
